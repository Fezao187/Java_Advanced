...
import listing1_5.CountDownNew;
import listing1_6.LaunchEventNew;
...
public class CountDownAppNew {
    public static void main(String[] args) {
        ...
        ignition = new LaunchEventNew("Start the engines!");
        liftoff = new LaunchEventNew("Liftoff");
        for (int t = 20; t >= 0; t--)
            pool.schedule(new CountDownNew(t), 20 - t, TimeUnit.SECONDS);
